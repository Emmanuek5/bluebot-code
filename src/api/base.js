      ...
      switch (path) {
        case "/api/v1/auth/create":
          ...
          if (this.routes["/api/v1/auth/create"].method == method) {
            ...
            res.send(
              "Usage: " + this.routes["/api/v1/auth/create"].method.toUpperCase + ": " + path
            );
          }
        ...
        case "/api/v1/user":
          if (this.routes["/api/v1/user"].method == method) {
            ...
            res.send("Usage: " + this.routes["/api/v1/user"].method.toUpperCase + ": " + path);
          }
        case "/api/v1/user/economy":
          ...
          if (this.routes["/api/v1/user/economy"].method == method) {
            ...
            res.send(
              "Usage: " + this.routes["/api/v1/user/economy"].method.toUpperCase + ": " + path
            );
          }
          break;

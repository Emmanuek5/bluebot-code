...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption(options =>
      options.setName("target").setDescription("The target member to slap").setRequired(true)
    )
    .addStringOption(option =>
      option.setName("robintext").setDescription("what the target says").setRequired(true)
    )
    .addStringOption(option =>
      option.setName("batmantext").setDescription("what you say back").setRequired(true)
    ),
  /**
   *

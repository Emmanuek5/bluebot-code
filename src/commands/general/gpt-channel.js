...
const { SlashCommandBuilder, Colors, ChannelType, PermissionFlagsBits, PermissionsBitField } = require('discord.js');
...
module.exports = {
  ...
  data: new SlashCommandBuilder().setName('gpt-channel').setDescription('Creates A New Chat-Gpt Conversation'),

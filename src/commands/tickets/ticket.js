...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (subcommand === 'create') {
      ...
      const ticket = await ticketSchema.findOne({ guildID: interaction.guild.id, userID: interaction.user.id });
      if (ticket) {
      ...
      if (!ticket) {
        ...
        channel.delete();
        await ticketSchema.findOneAndDelete({ guildID: interaction.guild.id, userID: interaction.user.id });
        interaction.reply({ embeds: [embed] });
      }
